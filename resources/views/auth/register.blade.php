...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Új felhasználó regisztrációja</div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input @error('aszf') is-invalid @enderror" type="checkbox" name="aszf" id="remember" {{ old('aszf') ? 'checked' : '' }} required>
